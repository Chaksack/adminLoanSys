      ...
      <div class="sm:flex sm:items-center">
        ...
        <div class="flex-auto">
          <p class="mt-2 text-sm text-gray-700">
            A list of all the Domains in your account including their name,
            title, email.
          </p>
        </div>
              ...
              <table class="min-w-full divide-y divide-gray-300">
                ...
                <tbody class="divide-y divide-gray-200 bg-white">
                  <tr
                    ...
                    :key="index"
                    @click="setIsTable(true, domain.id)"
                  >
                    <td
  ...
  methods: {
    ...
    deleteBorrowers() {
      ...
      deleteBAPI
        ...
        .then((response) => {
          this.domains = response.data.pageItems;
          console.log(response.data);
        })
        .catch((error) => {
          console.log("There was an error:", error.data);
